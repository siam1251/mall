...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private int mTabViewMainViewId;
     ...
     */
    public void setCustomTabView(int layoutResId, int mainViewId, int textViewId) {
        mTabViewLayoutId = layoutResId;
        mTabViewMainViewId = mainViewId;
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            View tabView = null;
            View tabMainView = null;
            View tabTextView = null;

            if (mTabViewLayoutId != 0) {
                // If there is a custom tab view layout id set, try and inflate it
                tabView = LayoutInflater.from(getContext()).inflate(mTabViewLayoutId, mTabStrip,
                        false);
                tabMainView = tabView.findViewById(mTabViewMainViewId);
                tabTextView = tabView.findViewById(mTabViewTextViewId);
            }
            ...
            if (tabMainView == null && TextView.class.isInstance(tabView)) {
                tabMainView = tabView;
            }
            ...
            if (TextView.class.isInstance(tabMainView)) {
                ((TextView) tabMainView).setText(adapter.getPageTitle(i));
            } else if (ImageView.class.isInstance(tabMainView) && adapter instanceof TabIconProvider){
                TabIconProvider mTabIconProvider = (TabIconProvider) adapter;
                tabMainView.setBackgroundResource(mTabIconProvider.getPageIconResId(i));
                ((TextView) tabTextView).setText(adapter.getPageTitle(i));
            }
