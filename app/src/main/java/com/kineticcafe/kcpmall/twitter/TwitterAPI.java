...
import com.kineticcafe.kcpmall.utility.HttpUtil;
...
public class TwitterAPI {
    ...
    static String TWITTER_STREAM_URL = "https://api.twitter.com/1.1/statuses/user_timeline.json?screen_name=";

    public TwitterAPI(String twitterAPIKey, String twitterApiSecret, int numbOfTweets){
        this.twitterApiKey = twitterAPIKey;
        this.twitterAPISecret = twitterApiSecret;
        if(numbOfTweets != 0){
            TWITTER_STREAM_URL = "https://api.twitter.com/1.1/statuses/user_timeline.json?count=" + numbOfTweets + "&screen_name=";
        }
    }
