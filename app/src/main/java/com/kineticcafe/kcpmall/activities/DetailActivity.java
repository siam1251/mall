...
//        setContentView(R.layout.activity_detail); //normal
        setContentView(R.layout.activity_detail_with_ctl); //with CTL
        ...
        setUpCTA();
        showContentsWithCTL(); //with CTL
//        showContents(); //without CTL
    }
        ...
        try {
            ...
            if(imageUrl.equals("")){
                ...
                if(daysLeft.equals("")){
                    ...
                    tvExpiryDate.setAnimation(new ExpiryDateAnimation().getAnimation());
                }
            }
    ...
    public void showContents(){
        ...
        try {
            final KcpContentPage kcpContentPage = (KcpContentPage) getIntent().getSerializableExtra(Constants.ARG_CONTENT_PAGE);
            getSupportActionBar().setTitle(KcpContentTypeFactory.getContentTypeTitle(kcpContentPage));
            ...
            AppCompatButton btnDetailDate = (AppCompatButton) findViewById(R.id.tvDetailDate);
